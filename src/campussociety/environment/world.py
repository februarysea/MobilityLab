...
from campussociety.environment.facilities import FacilityStore, RuntimeFacility
from campussociety.environment.movement import MovementIntent, MovementKernel
from campussociety.environment.network import RuntimeNetwork
...
class Environment:
    ...
    def snapshot_state(self) -> State:
        return {
            ...
            "schema": "campussociety.environment.v1",
