...
from campussociety.experiments.traces import TraceRecord
...
class ReplayFrame:
    ...
    schema: str = "campussociety.experiment.replay_frame.v1"
...
class ReplayManifest:
    ...
    schema: str = "campussociety.experiment.replay_manifest.v1"
