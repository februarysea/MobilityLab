...
VISUALIZATION_MANIFEST_SCHEMA_VERSION = "campussociety.visualization.manifest.v1"
...
class VisualizationDataset:
    ...
    metadata: Mapping[str, JsonValue] = field(default_factory=dict)
    schema: str = "campussociety.visualization.dataset.v1"
...
class DatasetCatalog:
    ...
    schema: str = "campussociety.visualization.dataset_catalog.v1"
