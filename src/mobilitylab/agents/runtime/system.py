...
from mobilitylab.agents.errors import AgentDecisionError
...
from mobilitylab.agents.state import AgentLifecycleStatus
from mobilitylab.core.entities import EntityId, JsonValue, State
from mobilitylab.core.events import Event
from mobilitylab.core.scheduler import ScheduledTask
from mobilitylab.core.simulation import RunContext
from mobilitylab.environment.movement import MovementIntent
from mobilitylab.environment.observation import ObservationRequest
...
class AgentSystem:
    ...
    def snapshot_state(self) -> State:
        return {
            ...
            "schema": "mobilitylab.agents.system.v1",
            "agent_count": len(self.agents),
            "decision_executor_id": self.decision_executor.executor_id,
